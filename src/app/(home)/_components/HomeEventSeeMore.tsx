...
export default function HomeEventSeeMore() {
  return (
    <div className="flex w-full gap-4 bg-zinc-100 px-4 py-12 md:px-20 md:py-20">
      <div>
        <div className="text-xl font-medium md:text-4xl">
          Personalized dermatology care for all skin types and conditions
        </div>

        <div className="mt-4 text-sm break-keep text-zinc-700 md:text-lg">
        ...
        <Link
          href="/"
          className="mt-10 inline-block rounded-full bg-zinc-900 px-8 py-3 text-center text-sm text-white"
        >
          이벤트 보러 가기
        </Link>
      </div>
